...
public class ConstrutorBotao implements IBuildBotao{
	...
	final private TextureRegionDrawable TEXREG_VAZIO = new TextureRegionDrawable(TEX_VAZIO);
	final private TextureRegionDrawable TEXREG_OVERLAY = new TextureRegionDrawable(TEX_OVERLAY);
	
	final private ImageButtonStyle STYLE_BOTAO_IMAGEM_VAZIO =  new ImageButtonStyle(TEXREG_VAZIO, TEXREG_VAZIO, TEXREG_OVERLAY, TEXREG_VAZIO, TEXREG_VAZIO, TEXREG_OVERLAY);
